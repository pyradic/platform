...
use Anomaly\Streams\Platform\Ui\ControlPanel\Component\Button\Guesser\PermissionGuesser;
...
class ButtonGuesser
{
     ...
     */
    public function __construct(HrefGuesser $href, TextGuesser $text, TypeGuesser $type, EnabledGuesser $enabled, PermissionGuesser $permission)
    {
        $this->href    = $href;
        $this->text    = $text;
        $this->type    = $type;
